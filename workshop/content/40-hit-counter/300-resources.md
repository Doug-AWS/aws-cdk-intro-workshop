...
Now, let's define the AWS Lambda function and the DynamoDB table in your
...
```console
npm install @aws-cdk/aws-dynamodb@0.25.3
```
...
{{<highlight ts "hl_lines=3 12-13 18-33">}}
...
we deploy your stack (notice that we haven't configured these physical names when
